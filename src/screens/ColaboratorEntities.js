...
function ColaboratorEntities() {
    return (
        <main className="App">
            ...
            <h4>Nuestro proyecto recibe ayudas y subvenciones de los asociados y de diversas entidades públicas y privadas que hacen posible la transformación social del entorno.</h4>
...
export default ColaboratorEntities;    
