...
function DescriptionComponent() {
    return (
        <div>
            ...
            <p>Durante esos 20 años, Asociación Juvenil Manos Abiertas ha trabajado también en la creación de redes entre los distintos colectivos que trabajan en la zona manteniendo una estrecha colaboración y coordinación con diferentes entidades, administraciones públicas y privadas y centros educativos.</p>
            <p>En 2015, cambia su denominación a Asociación Manos Abiertas con Norte y profesionaliza su intervención en la zona con la inclusión de una persona trabajadora en la entidad. En la actualidad la entidad está formada por un equipo técnico de 4 personas, 40 personas voluntarias y 70 asociadas. La Junta Directiva está formada por 7 personas asociadas y mantiene un trabajo en red y coordinado con más de 30 entidades públicas y privadas.</p>
        </div>
    );
}
