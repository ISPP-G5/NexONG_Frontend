    ...
    return (
        ...
        >
            <div className='agenda-intro'>
                <div>
                    <h1>La Salle</h1>
                    <p>En 2016 Asociación Manos Abiertas con Norte se suma a la Red de Obras Socioeducativas de La Salle. LA SALLE es una Institución implantada en casi un centenar de países que se dedica a la Educación. </p>
            ...
            <div className='agenda-plan'>
                ...
                <div>
                    ...
                    <p>la Red de Obras La Salle incluye Centros educativos, Centros educativos preuniversitarios y de formación profesional, universidades y Obras socioeducativas en España y Portugal, éstas obras se encuentran agrupadas en la Coordinadora de Obras Socioeducativas La Salle.</p>
                    <p>En la actualidad ocho entidades forman parte esta Coordinadora La Salle y otras tres colaboran con ella.</p>
